          ...
          <div className="flex gap-3">
            {socialLinks.map((link) => (
              <a
                ...
                href={link.href}
                className={`flex items-center justify-center rounded-full border border-gray-200 bg-white px-3 py-1.5 text-[0.65rem] font-semibold text-gray-700 transition hover:border-indigo-300 hover:text-indigo-600 sm:text-xs`}
              >
                {link.icon}
              </a>
            ))}
